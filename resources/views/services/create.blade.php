        ...
        <div class="relative rounded-2xl overflow-hidden mb-8 bg-gradient-to-r from-purple-600 to-indigo-600">
            ...
            <div class="relative z-10 py-8 px-8 text-white">
                <div class="flex items-center gap-3 mb-2">
                    <h1 class="text-3xl md:text-4xl font-bold">Добавление услуги</h1>
                </div>
                <p class="text-lg opacity-90">Заполните информацию об услуге</p>
            </div>
        </div>
                ...
                <div>
                    ...
                    <div id="dropZone"
                        ...
                        <label for="image" class="cursor-pointer block">
                            ...
                            <p class="text-gray-600 font-medium">Нажмите для загрузки изображения</p>
                    ...
                    <div id="imagePreview" class="mt-4 hidden">
                        <div class="relative inline-block">
                            ...
                            <button type="button" onclick="removeImage()" class="absolute -top-2 -right-2 w-6 h-6 bg-red-500 rounded-full flex items-center justify-center text-white text-xs hover:bg-red-600 transition shadow-md">
