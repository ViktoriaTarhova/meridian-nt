{{-- resources/views/properties/rent.blade.php --}}
@extends('layouts.app')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="relative rounded-2xl overflow-hidden mb-12 bg-gradient-to-r from-purple-600 to-indigo-600">
        ...
        <div class="relative z-10 py-10 px-8 text-white">
            <h1 class="text-4xl md:text-5xl font-bold mb-3">Аренда</h1>
            <p class="text-lg md:text-xl opacity-90">Снимите квартиру или дом своей мечты</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 mb-8 border border-gray-100">
        <form method="GET" action="{{ route('properties.rent') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            <div>
    ...
    @auth
        @if(Auth::user()->isAdmin() || Auth::user()->isAgent())
            <div class="mb-6 flex justify-end">
                <a href="{{ route('properties.create', ['type' => 'rent']) }}"
                ...
                <div class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 will-change-transform">
                    <div class="relative h-56 overflow-hidden rounded-t-2xl">
                        ...
                        <div class="absolute top-3 left-3 gradient-bg text-white px-3 py-1 rounded-lg text-sm font-bold shadow-lg z-10">
                            {{ number_format($property->price, 0, '.', ' ') }} ₽/мес
                        </div>
                        ...
                        <div class="absolute bottom-3 left-3 bg-black/50 backdrop-blur-sm text-white px-3 py-1 rounded-lg text-xs z-10">
                            <i class="fas fa-key mr-1"></i> Аренда
                        </div>
                    </div>
    ...
    @else
        <div class="text-center py-16 bg-white rounded-2xl shadow-lg">
            ...
            <h3 class="text-2xl font-semibold text-gray-700 mb-2">Объекты не найдены</h3>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2">
                    ...
                    <div class="text-3xl font-bold gradient-text mb-4">${new Intl.NumberFormat('ru-RU').format(property.price)} ₽/мес</div>
